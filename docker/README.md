...
The [.NET Docker samples](https://github.com/xaxdev/dotnet/dotnet-docker/blob/master/samples/README.md) show various ways to use .NET and Docker together. See [Building Docker Images for .NET Applications](https://docs.microsoft.com/dotnet/core/docker/building-net-docker-images) to learn more.
...
You can quickly run a container with a pre-built [.NET Docker image](https://hub.docker.com/_/microsoft-dotnet-core-samples/), based on the [ASP.NET Core sample](https://github.com/xaxdev/dotnet/dotnet-docker/blob/master/samples/aspnetapp/README.md).
...
* [.NET license](https://github.com/xaxdev/dotnet-docker/blob/master/LICENSE)
* [Discover licensing for Linux image contents](https://github.com/xaxdev/dotnet-docker/blob/master/documentation/image-artifact-details.md)
